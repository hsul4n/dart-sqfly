...
class ProxyInclude<T extends Dao, R extends Dao> extends Relation<T> {
  Dao get parent => Sqfly.instance.daos[T];
  List<Dao> get children => [Sqfly.instance.daos[R]];
...
class ProxyInclude0<T extends Dao, R1 extends Dao, R2 extends Dao>
  ...
  List<Dao> get children => [...super.children, Sqfly.instance.daos[R2]];
...
class ProxyInclude1<T extends Dao, R1 extends Dao, R2 extends Dao,
  ...
  List<Dao> get children => [...super.children, Sqfly.instance.daos[R3]];
